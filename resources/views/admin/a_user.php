...
.container {
   ...
   <p style="font-size:30px; text-align: center;color: black;">به نام خدا</p>
       ...
       <div>
       <p>راهنمایی:</p>
       <p>کاربر دارای شماره نقش 2 ادمین سایت1 و برنامه نویس 3 می باشد.</p>
       </div>
       <br><h1 id="home">لیست افراد عضو در سایت</h1><br>
      <div >
      <?php
...
<br><h1 id="home">تغییر کاربری کاربر</h1><br>
<div class="grid-container">
       <div class="grid-item">
          <form action="/adduser" method="post">
            <div class="form-control">
                <label for='name'>شماره کاربر</label>
                <input type="text" id="name" name="id" placeholder="شماره" autocomplete="off">
            </div> <br>
            <div class="form-control">
            <label for='name'>شماره شناسه جدید</label>
                <input type="text" id="name" name="role_id" placeholder="رمزکاربر" autocomplete="off">
            </div> <br>
