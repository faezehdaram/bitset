...
$sql = "SELECT id, lesson_name,lessom_time ,profossor,student_num,price,date FROM education where id>6";
...
<form action="/trsapt" method="post">
      ...
      $sql2="SELECT id,name,text,education_id FROM table__ecomment where education_id>6";
...
<form action="/tcomment" method="post">
            ...
            <div class="form-control"style="width: 50%;">
                ...
                <input type="text" id="education_id" name="education_id" placeholder="شماره مقاله مربوطه" autocomplete="off">
            </div>
            <br>
                <input type="submit" value="ارسال">
